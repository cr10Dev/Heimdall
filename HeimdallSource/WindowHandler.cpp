...
bool WindowHandler::CreateDeviceD3D(HWND hWnd)
{
    // Setup swap chain
...
void WindowHandler::CleanupDeviceD3D()
{
    CleanupRenderTarget();
...
void WindowHandler::CreateRenderTarget()
{
...
void WindowHandler::CleanupRenderTarget()
{
